...
- [MASTG: Testing for WebView JavaScript Bridges](https://mas.owasp.org/MASTG/tests/android/MASVS-PLATFORM/MASTG-TEST-0031/)
- [MASWE-0069: Insecure JavaScript-to-Native Bridge Exposure](https://mas.owasp.org/MASWE/MASVS-PLATFORM/MASWE-0069/)
- [Android `WebView.addJavascriptInterface()` — API reference & security notes](https://developer.android.com/reference/android/webkit/WebView#addJavascriptInterface(java.lang.Object,%20java.lang.String))
- [DSBridge for Android (the JS bridge library used by the app)](https://github.com/wendux/DSBridge-Android)
...
- [Android: Security with HTTPS and SSL (certificate pinning)](https://developer.android.com/privacy-and-security/security-ssl)
